<%-- 
    ...
    Created on : Mar 14, 2025, 3:15:23 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="sidebar">
            <div class="logo-area">
                <i class="bi bi-shop"></i> PetShop Admin
            </div>
            <nav class="nav flex-column">
                <a class="nav-link" href="ManageIssueAdminController?action=list">
                    <i class="bi bi-truck"></i> Manage Delivery Issues
                </a>
            ...
            <div class="profile-dropdown">
                <button class="profile-btn">
                    <img src="${pageContext.request.contextPath}/images/admin-avatar.jpg" 
                         alt="Admin Avatar" class="profile-img">
