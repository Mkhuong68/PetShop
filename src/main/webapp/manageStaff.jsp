    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <nav class="nav flex-column">
                <a class="nav-link" href="${pageContext.request.contextPath}/AccountManagement">
                ...
                <!-- Thay đổi Manage Promotion thành nút kích hoạt modal -->
                <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#promotionModal">
                ...
                <a class="nav-link" href="${pageContext.request.contextPath}/StaffPostController">
                    <i class="bi bi-file-text"></i> Manage Post
                </a>
                <a class="nav-link" href="${pageContext.request.contextPath}/StaffCommentController">
        ...
        <!-- Modal for Manage Promotion -->
        <div class="modal fade" id="promotionModal" tabindex="-1" aria-labelledby="promotionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="promotionModalLabel">Manage Promotion</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p>Please select an option:</p>
                        <a href="${pageContext.request.contextPath}/ProductPromotionController?action=add" class="btn btn-primary m-2">Add Promotion</a>
                        <a href="${pageContext.request.contextPath}/ProductPromotionController" class="btn btn-secondary m-2">Update Promotion</a>
                    </div>
