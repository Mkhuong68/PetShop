                                ...
                                <c:forEach var="product" items="${productList}" varStatus="loop">
                                    <div class="product-item">
                                        <a href="ProductDetail?productId=${product.productId}">
                                            ...
                                            <span class="price">
                                                <c:if test="${not empty promotionList[loop.index]}">
                                                    <div class="price-row">
                                                        ...
                                                        <span class="discount-percentage">
                                                            ...
                                                            -${promotionList[loop.index].discountPercentage}%
                                                        </span>
                                                    </div>
                                                    <div class="discounted-price">
                                                        <fmt:formatNumber value="${promotionList[loop.index].discountedPrice}" pattern="#,##0" /> VND
                                                    </div>
                                                </c:if>
                                                <c:if test="${empty promotionList[loop.index]}">
                                                    <fmt:formatNumber value="${product.productPrice}" pattern="#,##0" /> VND
                                                </c:if>
                                            </span>
                                        </a>
...
.product-item .price {
   ...
   color: #ff0000;
    ...
    .discount-percentage {
        display: flex;
        align-items: center;
        background-color: #ffe6cc; /* Nền cam nhạt */
        color: #ff6200; /* Màu cam đậm */
        font-size: 14px;
        font-weight: bold;
        padding: 2px 8px;
        border-radius: 12px;
    ...
    .discounted-price {
        color: #ff0000;
        font-weight: bold;
        font-size: 16px; /* Giảm font-size để cân đối khi nằm cùng hàng */
    }
</style>
